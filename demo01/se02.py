...
class TestCase(object):
    ...
    def test_xpath(self):
        self.driver.find_element_by_xpath('//*[@id="kw"]').send_keys('hello world')
        self.driver.find_element_by_id('su').click()
        sleep(3)
    ...
    def test_css_selector(self):
        self.driver.find_element_by_css_selector('#kw').send_keys('hello world')
        self.driver.find_element_by_id('su').click()
        sleep(3)

    def test_class_name(self):
        self.driver.find_element_by_class_name('s_ipt').send_keys('hello world')
        self.driver.find_element_by_id('su').click()
        sleep(3)
        self.driver.quit()
